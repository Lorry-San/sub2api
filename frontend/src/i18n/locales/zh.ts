    ...
    accounts: {
      ...
      oauth: {
        ...
        kiro: {
          ...
          builderDesc: '默认 AWS Builder ID Start URL',
          iamDesc: '企业 IAM Identity Center Start URL',
          loginModeLabel: '登录方式',
          deviceLogin: 'AWS Builder / IAM 设备登录',
          kiroIDELogin: 'KiroIDE PKCE 登录',
          startUrlLabel: 'Start URL',
          startUrlPlaceholder: 'https://view.awsapps.com/start 或企业 Start URL',
          startUrlHint: '企业 IAM Identity Center 账号和 RT 导入需要填写。',
          startUrlRequired: 'IAM Login 请填写企业 Start URL。',
          redirectUriLabel: 'Redirect URI',
          missingCallbackUrl: '请粘贴 localhost 回调完整 URL。',
          failedToStartKiroIDE: '启动 KiroIDE 登录失败',
          failedToExchangeKiroIDE: '交换 KiroIDE 授权码失败',
          kiroIDEStep1GenerateUrl: '生成 KiroIDE 登录链接',
          kiroIDEGenerateAuthUrl: '生成 KiroIDE 链接',
          kiroIDEStep2OpenUrl: '打开 KiroIDE 登录链接',
          kiroIDEOpenUrlDesc: '登录完成后浏览器会跳转到 localhost，请复制地址栏中的完整 URL。',
          kiroIDEStep3EnterCode: '粘贴回调 URL',
          kiroIDEAuthCodeDesc: '粘贴完整 localhost 回调 URL，例如 http://localhost:3128?code=...&state=...',
          kiroIDEAuthCode: '回调 URL',
          kiroIDEAuthCodePlaceholder: 'http://localhost:3128?code=...&state=...',
          kiroIDEAuthCodeHint: '系统会校验 state 是否匹配本次 PKCE 会话。'
        }
      },
