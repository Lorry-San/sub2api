...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	kiroGatewayService := service.ProvideKiroGatewayService(accountRepository, httpUpstream, kiroOAuthService, schedulerSnapshotService)
	...
	accountUsageService := service.NewAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, kiroOAuthService, usageCache, identityCache, tlsFingerprintProfileService)
