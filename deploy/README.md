...
curl -sSL https://raw.githubusercontent.com/Lorry-San/sub2api/main/deploy/docker-deploy.sh | bash

# Or download first, then run
curl -sSL https://raw.githubusercontent.com/Lorry-San/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
```bash
# Clone repository
git clone https://github.com/Lorry-San/sub2api.git
cd sub2api/deploy
...
```bash
curl -sSL https://raw.githubusercontent.com/Lorry-San/sub2api/main/deploy/install.sh | sudo bash
```

### Manual Installation

1. Download the latest release from [GitHub Releases](https://github.com/Lorry-San/sub2api/releases)
