...
GITHUB_REPO="${SUB2API_GITHUB_REPO:-Lorry-San/sub2api}"
GITHUB_BRANCH="${SUB2API_GITHUB_BRANCH:-main}"
GITHUB_RAW_URL="${SUB2API_GITHUB_RAW_URL:-https://raw.githubusercontent.com/${GITHUB_REPO}/${GITHUB_BRANCH}/deploy}"
